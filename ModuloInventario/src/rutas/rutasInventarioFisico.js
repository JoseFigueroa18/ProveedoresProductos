...
rutas.get('/filtro',
    query('filtro')
        .notEmpty().withMessage('Debe escribir el id del producto')
        //.isNumeric().withMessage('El id del inventario fisico debe ser entero')
    ,
    controladorInventarioFisico.BuscarFiltro);
